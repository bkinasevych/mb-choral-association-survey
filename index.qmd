...
df <- singer_data_full |> 
    select(starts_with("barriers"), -contains("other")) |> 
    pivot_longer(cols = everything()) |> 
    count(value) |> 
    drop_na() |> 
    mutate(pct = n/n_respondents,
...
df <- singer_data_full |> 
    select(starts_with("barriers"), -contains("other"), age_group_collapsed) |> 
    pivot_longer(cols = -age_group_collapsed) |> 
    group_by(age_group_collapsed) |> 
    count(value) |> 
    drop_na() |> 
...
df <- singer_data_full |> 
    select(starts_with("barriers"), -contains("other"), time_performing_collapsed) |> 
    pivot_longer(cols = -time_performing_collapsed) |> 
    group_by(time_performing_collapsed) |> 
    count(value) |> 
    drop_na() |> 
