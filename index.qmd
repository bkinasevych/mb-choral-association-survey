...
df <- singer_data_full |> 
    select(starts_with("motivation"), -contains("other")) |> 
    pivot_longer(cols = everything()) |> 
    drop_na(value) |> 
    count(value) |> 
    mutate(pct = n/n_respondents,
...
df <- singer_data_full |> 
    select(age_group_collapsed, starts_with("motivation"), -contains("other")) |> 
    pivot_longer(cols = -age_group_collapsed) |> 
    group_by(age_group_collapsed) |> 
    count(value) |> 
    drop_na() |> 
...
df <- singer_data_full |> 
    select(time_performing_collapsed, starts_with("motivation"), -contains("other")) |> 
